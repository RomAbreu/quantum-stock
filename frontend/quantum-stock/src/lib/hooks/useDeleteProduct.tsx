...
export function useDeleteProduct({
  ...
  const handleRefreshNotifications = async () => {
    if (refreshNotifications) {
      try {
        ...
        console.log('✅ Notificaciones refrescadas exitosamente después de eliminar producto');
      } catch (error) {
  ...
  const deleteProductById = async (productId: string, productName?: string): Promise<boolean> => {
