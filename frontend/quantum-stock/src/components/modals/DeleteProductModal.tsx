        ...
        <ModalHeader className="flex flex-col gap-1">
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-8 h-8 rounded-full bg-red-500/20">
              <Icon icon="solar:trash-bin-minimalistic-bold" className="text-lg text-red-500" />
            </div>
        ...
        <ModalBody>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-2 p-3 rounded-lg bg-warning-50 dark:bg-warning-900/20">
              <Icon icon="solar:danger-triangle-bold" className="mt-0.5 text-warning-500 flex-shrink-0" />
              <div className="text-sm text-warning-700 dark:text-warning-300">
                <p className="mb-1 font-medium">Esta acción es irreversible</p>
                <p>El producto será eliminado permanentemente del inventario y no podrá ser recuperado.</p>
              </div>
            </div>
          </div>
        </ModalBody>
